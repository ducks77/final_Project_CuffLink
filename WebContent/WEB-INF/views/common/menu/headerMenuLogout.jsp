...
<div class="ui segment" style="margin-top: 0px; padding-top: 3px; padding-bottom: 3px; margin-bottom: 0px;background-color:#2d3a45">
	<div class="ui container">
		...
		<div class="ui inverted secondary pointing menu" style="margin-top: 0px;">
			<a href="../auth/login" id="projectRegister" class="projectRegister item">프로젝트 등록 </a> <a href="../project/page" id="projectFind" class="projectFind item">프로젝트 찾기 </a> <a href="../partners/partnersList" id="partnersList" class="partnersList item">파트너스 목록 </a>
