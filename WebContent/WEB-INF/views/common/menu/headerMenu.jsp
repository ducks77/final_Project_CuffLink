		...
		<div class="ui inverted secondary pointing menu" style="margin-top: 0px;">
			...
			<form id="f_logout">
				<div id="menu_list" class="ui dropdown" style="width: 150px;">
					<div class="ui dropdown fluid  button" id="out_id" style="color:#fff;background-color:#2d3a45;">
						<%
							if (info != null)
...
<div class="submenu" style="border-bottom: groove thin;background-color: #dadee2;">
	<div class="ui container">
		<div class="ui secondary menu">
			<!-- ************************* 메뉴버튼클릭시 활성화효과 -->
			<a href="../project/projectRecruiting" id="projectRecruiting" class="projectRecruiting teal item"> 지원자 모집중 </a> <a href="../project/projectContractInProgress" id="projectContractInProgress" class="projectContractInProgress teal item"> 진행중인 프로젝트 </a>
			<!-- 수정 20181017 시작 -->
			<a href="../project/projectCompletedContract" id="projectReviewContract" class="projectReviewContract teal item"> 종료된 프로젝트 </a>
			<!-- 수정 20181017 끝 -->
			<!-- ************************* 메뉴버튼클릭시 활성화효과 -->
		</div>
	</div>
