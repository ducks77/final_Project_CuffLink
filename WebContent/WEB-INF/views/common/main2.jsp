...
<body>
		...
		<div class="ui secondary pointing menu" style="margin-bottom: 0px;">
			...
			<div class="right menu">
				<div class="item">
					...
					<button class="ui primary button" style="margin-right: 10px;" onclick="location.href='/auth/join1'">회원가입</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="ui container" style="padding: 0;">
		<div class="vedio">
		<!-- https://www.youtube.com/embed/watch?v=cevDCSRNQMI -->
			<iframe width="1125" height="640" src="https://www.youtube.com/embed/7_MkNvme92I?autoplay=1&origin&controls=0&autohide=2&showinfo=0&modestbranding=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
		</div>
	</div>	
	
	<!-- 기존 3개의 화면으로 동영상연결 잘안됨 -->
			...
			<div class="ui horizontal segments">
				...
				<div class="ui segment" style="width: 33.3%; border: 1px solid #fff;  color:#fff;" align="center" >
					...
					<button class="ui button blue" onclick="location.href='/auth/login'">
						<h4>무료로 프로젝트 등록하기1</h4>
					</button>
				</div>
				<div class="ui segment" style="width: 33.3%; border: 1px solid #fff;">
					<video width="320" height="240" autoplay>
					  <source src="image/video/bbb.mp4" type="video/mp4">
					</video>
				</div>
			</div>
		</div> -->
